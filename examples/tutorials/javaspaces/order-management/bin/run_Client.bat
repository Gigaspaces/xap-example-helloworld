...
rem
rem jini://localhost/./oms?groups=%LOOKUPGROUPS%	- The url of the space the client connects to.
...
rem
rem com.gigaspaces.examples.tutorials.ordermanagement.Client 	- Location of the client application class file.

%JAVACMD% -classpath ..\classes;%JARS% com.gigaspaces.examples.tutorials.ordermanagement.Client jini://localhost/./oms?groups=%LOOKUPGROUPS%
